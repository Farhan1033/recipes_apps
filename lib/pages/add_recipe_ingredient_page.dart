  ...
  Future<void> _loadIngredients() async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (data is Map && data['ingredient'] != null) {
          setState(() {
            _ingredients_list = (data['ingredient'] as List)
        ...
        _showSnackbar("Gagal mengambil data bahan: $errorMessage", isError: true);
      }
    } catch (e) {
  ...
  Future<void> _loadRecipes() async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        } else if (data is Map && data['recipes'] != null) {
          // Jika response dibungkus dalam objek dengan key 'data'
          setState(() {
            _recipes = (data['recipes'] as List).map((json) => Recipe.fromJson(json)).toList();
          });
        }
      } else {
        final errorData = jsonDecode(response.body);
        final errorMessage = errorData['message'] ?? 'Unknown error';
        _showSnackbar("Gagal mengambil data resep: $errorMessage", isError: true);
      }
    } catch (e) {
  ...
  Future<void> _submit() async {
    ...
    final List<Map<String, dynamic>> ingredientsData = _ingredients.map((ing) {
      return {
        ...
        "quantity": ing.quantityController.text.trim(),
    ...
    final url = Uri.parse("$baseUrl/recipe-ingredient/add-multiple-ingredients");
              ...
              children: [
                    ...
                    child: Column(
                      children: [
                        ...
                        DropdownButtonFormField<Ingredient>(
                          ...
                          onChanged: _isLoadingIngredients ? null : (Ingredient? selected) {
                            setState(() {
                ...
                Align(
                  ...
                  child: TextButton.icon(
                    ...
                    label: Text("Tambah Bahan", style: TextStyle(color: orangeDark)),
                  ),
                ),
